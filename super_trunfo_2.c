...
int main() {
    ...
    printf("--- SUPER TRUNFO - Analise Sistemas S1 Desafio 2 ---\n");
    ...
    /* validação dos cálculos apenas para debugar
    printf("Densidade 1: %.1f hab/Km2\n", densidade_1);
    printf("PIB per Capita 1: %.1f mil/hab\n", pibpercapita_1); 

    printf("Densidade 2: %.1f hab/Km2\n", densidade_2);
    printf("PIB per Capita 2: %.1f mil/hab\n", pibpercapita_2); 
    */

    //comparação dos PIB per capita
    printf("*** Clique ENTER para determinar a carta vencedora em PIB per Capita ***\n");
    fflush(stdin);
    getchar();
    getchar();

    if (pibpercapita_1 > pibpercapita_2) //se PIB per capita da carta um for o maior
    {
        printf("*** Vence a Carta 1 ***\n"); 
        printf("PIB per Capita 1: %.1f mil/hab\n", pibpercapita_1); 
        printf("PIB per Capita 2: %.1f mil/hab\n", pibpercapita_2); 
    } else { //se o check acima for falso, então
    printf("*** Vence a Carta 2 ***\n"); 
    printf("PIB per Capita 1: %.1f mil/hab\n", pibpercapita_1); 
    printf("PIB per Capita 2: %.1f mil/hab\n", pibpercapita_2); 
    }
